			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="active"><a class="nav-link" href="shop.html">Nos stades</a></li>
      ...
      try {
        ...
        while ($terrain = $requete->fetch()) {
          ...
          echo "<div class='col-12 col-md-4 col-lg-3 mb-5'>
                  <a class='product-item' href='terraindetails.php?id=" . $encrypted_id_terrain . "'>
                    <img src='data:image/jpeg;base64," . base64_encode($terrain['image']) . "' class='img-fluid product-thumbnail' alt='" . $terrain['nom_terrain'] . "'>
                    <h3 class='product-title'>" . $terrain['nom_terrain'] . "</h3>
                    <strong class='product-price'>" . $terrain['prix'] . " DNT</strong>
                    <span class='icon-cross'>
                      <a href='supprimer_terrain.php?id=" . $encrypted_id_terrain . "' onclick='return confirm(\"Voulez-vous vraiment supprimer ce terrain ?\");'>
