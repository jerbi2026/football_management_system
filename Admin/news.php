...
<body>
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <a class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasNews" role="button" aria-controls="offcanvasExample">
 Ajouter une nouvelle
</a>
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNews" aria-labelledby="offcanvasNewsLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasNewsLabel">Ajouter une Actualité</h5>
  ...
  <div class="offcanvas-body">
    ...
    <form id="news-form" method="POST" action="crud_news.php">
      <div class="mb-3">
