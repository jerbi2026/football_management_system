...
<head>
  ...
  <title>Kram foot | Terrains</title>
...
<body>
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <a class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasProduit" role="button" aria-controls="offcanvasExample">
 Ajouter un produit
</a>
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasProduit" aria-labelledby="offcanvasProduitLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasProduitLabel">Ajouter un Produit</h5>
  ...
  <div class="offcanvas-body">
    ...
    <form id="produit-form" method="POST" action="crud_produit.php" enctype="multipart/form-data">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select class="form-control" id="id_categorie" name="id_categorie" required>
          <!-- Options seront insérées ici depuis la base de données -->
          <?php
            include('php_fonctions/connexion.php');
            $query = "SELECT id_categorie, categorie FROM categorie";
      ...
      <button type="submit" class="btn btn-primary w-100 py-2">Ajouter</button>
    </form>
  </div>
</div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/images/back/back1.jpg" class="d-block w-100" alt="cover1">
    </div>
    <div class="carousel-item">
      <img src="assets/images/back/back2.jpg" class="d-block w-100" alt="cover2">
    </div>
    <div class="carousel-item">
      <img src="assets/images/back/back3.png" class="d-block w-100" alt="cover3">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
      ...
      <div class="row">
    <div class='nav nav-tabs' id='nav-tab' role='tablist' style="margin-top : 5%">
      <?php
      include('php_fonctions/connexion.php');
      try {
        ...
        while ($categorie = $requete->fetch()) {
          ...
          echo "<button class='nav-link $activeClass' data-bs-toggle='tab' data-bs-target='#" . $categorie['id_categorie'] . "' role='tab' aria-controls='" . $categorie['id_categorie'] . "' aria-selected='true'>" . $categorie['categorie'] . "</button>";
          $isFirst = false;
        }
      } catch (PDOException $e) {
  ...
  <div class="tab-content" id="nav-tabContent">
    ...
    try {
      ...
      while ($categorie = $requeteCategorie->fetch()) {
        ...
        echo "<div class='tab-pane fade $activeClass' id='" . $categorie['id_categorie'] . "' role='tabpanel' aria-labelledby='" . $categorie['id_categorie'] . "-tab' tabindex='0'>";
        echo"<div class='row'>";
        $requeteProduit = $bdd->prepare("SELECT * FROM produit WHERE id_categorie = ?");
        $requeteProduit->execute([$categorie['id_categorie']]);
        while ($produit = $requeteProduit->fetch()) {
          ...
          echo "<div class='col-sm-6 col-xl-3'>
                  <div class='card overflow-hidden rounded-2'>
                    <div class='position-relative'>
                      <a href='javascript:void(0)'><img src='data:image/jpeg;base64," . base64_encode($produit['image']) . "' alt='" . $produit['nom_produit'] . "' /></a>
                    </div>
                    <div class='card-body pt-3 p-4'>
                      <h6 class='fw-semibold fs-4'>" . $produit['nom_produit'] . "</h6>
                      <div class='d-flex align-items-center justify-content-between'>
                        <h6 class='fw-semibold fs-4 mb-0'>" . $produit['prix_produit'] . "DNT </h6>
                        <ul class='list-unstyled d-flex align-items-center mb-0'>
                          <li><a class='me-1' href='javascript:void(0)'><i class='ti ti-star text-success'></i></a></li>
                          <li><a class='me-1' href='javascript:void(0)'><i class='ti ti-star text-success'></i></a></li>
                          <li><a class='me-1' href='javascript:void(0)'><i class='ti ti-star text-success'></i></a></li>
                          <li><a class='me-1' href='javascript:void(0)'><i class='ti ti-star text-success'></i></a></li>
                          <li><a class='' href='javascript:void(0)'><i class='ti ti-star text-success'></i></a></li>
                        </ul>
                      </div>
                      <a href='produit_details.php?id=" . $encrypted_id_produit . "' class='btn btn-danger'>Supprimer Produit</a>
                    </div>
                  </div>
                </div>";
        }
