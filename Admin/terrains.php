...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Ajouter un Terrain</h5>
  ...
  <div class="offcanvas-body">
    ...
    <form id="terrain-form" method="POST" action="crud_terrain.php" enctype="multipart/form-data">
      <div class="mb-3">
        <label for="nom_terrain" class="form-label">Nom du Terrain</label>
        <input type="text" class="form-control" id="nom_terrain" name="nom_terrain" required>
      </div>
      <div class="mb-3">
            ...
            while ($terrain = $requete->fetch()) {
              ...
              <div class='card overflow-hidden rounded-2'>
                  ...
                  <div class='card-body pt-3 p-4'>
                      ...
                      <a href='terraindetails.php?id=" . $encrypted_id_terrain . "' class='btn btn-success'>View More</a>
                      <a href='supprimer_terrain.php?id=" . $encrypted_id_terrain . "' class='btn btn-danger' onclick='return confirm(\"Voulez-vous vraiment supprimer ce terrain ?\");'>Delete</a>
                  </div>
              </div>
            </div>";
