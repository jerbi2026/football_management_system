  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
          ...
          <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
            <div class="d-flex">
              <div class="unlimited-access-title me-3">
                <h6 class="fw-semibold fs-4 mb-6 text-dark w-85" href="upgrade_user.php">Upgrade to pro</h6>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
        <?php 
        $query = "SELECT * FROM notification WHERE id_user = ? order by date_notification DESC";
        $stmt = $bdd->prepare($query);
        $stmt->execute(array($user['id_user']));
        $notifications = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach ($notifications as $notification) {
           
            $notification_message = $notification['contenu_notification'];
            ...
            <div class='card'>
              <div class='card-body'>
                <p class='card-text'>$notification_message</p>
                <p class='card-text'><small class='text-muted'>$notification_date</small></p>
...
<?php 
        $query = "SELECT * FROM notification_global  order by date_notification DESC";
        $stmt = $bdd->prepare($query);
        $stmt->execute();
        $notifications = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach ($notifications as $notification) {
