  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <iframe width="100%" height="60" src="https://rss.app/embed/v1/ticker/ta55hjMeb6GXAYMC" frameborder="0"></iframe>
        <!--  Row 1 -->
        <div class="row">
          <script>
            (function(d, s, id) {
        ...
        <div class="row">
          ...
          include('php_fonctions/connexion.php');
          try {
            $requete = $bdd->query("SELECT * FROM tournois limit 3");
        
            while ($tournois = $requete->fetch()) {
              ...
              <div class='card-body'>
                ...
                <p class='card-text'>" . $tournois['description'] . "</p>
                <p class='card-text'>Nombre d'équipes restantes " . $tournois['nb_equipe_restant'] . "</p>";
                if($tournois['nb_equipe_restant'] > 0) {
                  echo "<a  class='card-link' href='tournois.php?id=" . $encrypted_id_tournoi . "'>Participate now</a>";
                } else {
                  echo "<a href='tournois.php?id=" . $encrypted_id_tournoi . "' class='btn btn-danger'>Complet</a>";
                }
                echo"<div class='btn-group' role='group' aria-label='Share' style='margin-left:5%'>
                  ...
                  <a href='https://www.facebook.com/sharer/sharer.php?u=" . urlencode('http://localhost') . "' class='btn btn-warning' target='_blank'><svg  xmlns='http://www.w3.org/2000/svg'  width='24'  height='24'  viewBox='0 0 24 24'  fill='none'  stroke='currentColor'  stroke-width='2'  stroke-linecap='round'  stroke-linejoin='round'  class='icon icon-tabler icons-tabler-outline icon-tabler-brand-facebook'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><path d='M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3' /></svg></a>
                  </div>
              </div>
            </div>";
...
?>
        ...
        <div class="row">
          <h2>Nos Terrains🏟️</h2>
          <?php
          include('php_fonctions/connexion.php');
          try {
            $requete = $bdd->query("SELECT * FROM terrain limit 4");
        
            while ($terrain = $requete->fetch()) {
              $encrypted_id_terrain = openssl_encrypt($terrain['id_terrain'], "AES-128-ECB" ,"uiop5258");
              ...
              <div class='card overflow-hidden rounded-2'>
                ...
                <div class='card-body pt-3 p-4'>
                  ...
                  <div class='d-flex align-items-center justify-content-between'>
                    <h6 class='fw-semibold fs-4 mb-0'>" . $terrain['prix'] . "DNT <span class='ms-2 fw-normal text-muted fs-3'><del>80 DNT</del></span></h6>
                  ...
                  <a href='terraindetails.php?id=" . $encrypted_id_terrain . "' class='btn btn-warning'>View More</a>
                </div>
              </div>
            </div>";
...
?>
        ...
        <div class="row">
          ...
          include('php_fonctions/connexion.php');
          try {
            $requete = $bdd->query("SELECT * FROM produit limit 8");
            ...
            while ($produit = $requete->fetch()) {
              ...
              <div class='card overflow-hidden rounded-2'>
                ...
                <div class='card-body pt-3 p-4'>
                  ...
                  <a href='produit_details.php?id=" . $encrypted_id_produit . "' class='btn btn-warning'>View More</a>
                </div>
              </div>
            </div>";
