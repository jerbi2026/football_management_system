    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <?php
                echo"<a onclick='addToCart(\"" . $produit['id_produit'] . "\", \"" . $userId . "\")' class='btn btn-warning'>Ajouter au panier</a>"; 
            ?>  
          ...
          echo "<div class='col-sm-6 col-xl-3'>
                  <div class='card overflow-hidden rounded-2'>
                    <div class='position-relative'>
                      ...
                      <a href='javascript:void(0)' class='bg-warning rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3' data-bs-toggle='tooltip' data-bs-placement='top' data-bs-title='Add To Cart' onclick='addToCart(\"" . $produit_autres['id_produit'] . "\", \"" . $userId . "\")'><i class='ti ti-basket fs-4'></i></a>
                      </div>
